...
Система управления видеонаблюдением на Go с веб-интерфейсом. Поддерживает подключение IP-камер по RTSP, live-трансляцию (MJPEG), запись видео в архив, просмотр записей и опциональное обнаружение людей на кадре (YOLOv8 + GoCV).
